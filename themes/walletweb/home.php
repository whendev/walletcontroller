        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6">
                ...
                <div class="text-center text-md-left pt-4">
                    <a class="btn btn-lg btn-primary hover-top-shadow mr-3" href="#">Cadastre-se
                    ...
                    <a class="btn btn-lg btn-light text-primary shadow-lg hover-top-shadow" href="">Fazer Login</a>
                </div>
            </div>
        </div>
    </div>
