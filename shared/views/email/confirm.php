<?php $v->layout("_theme", ["title" => "Confirme e ative sua conta no WalletController"]); ?>

<h2>Seja bem-vindo(a) ao WalletController <?= $first_name; ?>. Vamos confirmar seu cadastro?</h2>
